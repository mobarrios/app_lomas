    ...
    render() {
        ...
        return (core.h(core.Host, { role: "dialog", "aria-modal": "true", style: {
            ...
            core.h("div", { class: "action-sheet-group action-sheet-group-cancel" }, core.h("button", { type: "button", class: buttonClass(cancelButton), onClick: () => this.buttonClick(cancelButton) }, core.h("span", { class: "action-sheet-button-inner" }, cancelButton.icon &&
                core.h("ion-icon", { icon: cancelButton.icon, lazy: false, class: "action-sheet-icon" }), cancelButton.text)))))));
    }
...
const buttonClass = (button) => {
    return Object.assign({ 'action-sheet-button': true, 'ion-activatable': true, [`action-sheet-${button.role}`]: button.role !== undefined }, theme.getClassMap(button.cssClass));
};
