...
const haptic = require('./haptic-a7d83dba.js');
...
const Datetime = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { onClick: this.onClick, role: "combobox", "aria-disabled": disabled ? 'true' : null, "aria-expanded": `${isExpanded}`, "aria-haspopup": "true", "aria-labelledby": labelId, class: {
            ...
            } }, core.h("div", { class: "datetime-text" }, datetimeText), core.h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: btnEl => this.buttonEl = btnEl })));
    }
