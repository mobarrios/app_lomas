...
require('./config-773d6543.js');
const animation = require('./animation-5082fabd.js');
const overlays = require('./overlays-b6d954fa.js');
const theme = require('./theme-9139efee.js');
const index = require('./index-31bc374f.js');
...
const Toast = class {
    ...
    renderButtons(buttons, side) {
        ...
        return (core.h("div", { class: buttonGroupsClasses }, buttons.map(b => core.h("button", { type: "button", class: buttonClass(b), tabIndex: 0, onClick: () => this.buttonClick(b) }, core.h("div", { class: "toast-button-inner" }, b.icon &&
    ...
    render() {
        ...
        return (core.h(core.Host, { style: {
            ...
            }, class: Object.assign({ [mode]: true }, theme.createColorClasses(this.color), theme.getClassMap(this.cssClass), { 'toast-translucent': this.translucent }) }, core.h("div", { class: wrapperClass }, core.h("div", { class: "toast-container" }, this.renderButtons(startButtons, 'start'), core.h("div", { class: "toast-content" }, this.header !== undefined &&
            core.h("div", { class: "toast-header" }, this.header), this.message !== undefined &&
            core.h("div", { class: "toast-message", innerHTML: index.sanitizeDOMString(this.message) })), this.renderButtons(endButtons, 'end')))));
    }
