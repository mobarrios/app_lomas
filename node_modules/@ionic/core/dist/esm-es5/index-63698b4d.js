...
import { w as writeTask } from './core-13ed1ad7.js';
import { b as LIFECYCLE_WILL_LEAVE, L as LIFECYCLE_WILL_ENTER, a as LIFECYCLE_DID_ENTER, c as LIFECYCLE_DID_LEAVE } from './constants-94c4865f.js';
var iosTransitionAnimation = function () { return import('./ios.transition-5c2f00df.js'); };
var mdTransitionAnimation = function () { return import('./md.transition-e0e9d421.js'); };
...
var animation = function (animationBuilder, opts) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, import('./index-f98adfdd.js').then(function (mod) { return mod.create(animationBuilder, opts.baseEl, opts); })];
            case 3:
                trans = _a.sent();
                return [3 /*break*/, 5];
            case 4:
