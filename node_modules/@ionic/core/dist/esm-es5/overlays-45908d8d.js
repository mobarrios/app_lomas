...
var overlayAnimation = function (overlay, animationBuilder, baseEl, opts) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var aniRoot, animation, isAnimationBuilder, animationResult, hasCompleted;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, import('./index-f98adfdd.js').then(function (mod) { return mod.create(animationBuilder, aniRoot, opts); })];
            case 1:
                animation = _a.sent();
                isAnimationBuilder = animation.fill === undefined;
            ...
            case 2:
                ...
                hasCompleted = (typeof animationResult === 'boolean') ? animationResult : animation.hasCompleted;
                if (isAnimationBuilder) {
                    animation.destroy();
                }
                overlay.animation = undefined;
...
export { BACKDROP as B, alertController as a, actionSheetController as b, popoverController as c, present as d, dismiss as e, eventMethod as f, createOverlay as g, dismissOverlay as h, isCancel as i, getOverlay as j, loadingController as l, modalController as m, pickerController as p, safeCall as s, toastController as t };
