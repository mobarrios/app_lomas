import { r as registerInstance, c as createEvent, d as getIonMode, h, e as getElement, H as Host } from './core-13ed1ad7.js';
...
import { l as lifecycle, t as transition, s as setPageHidden } from './index-63698b4d.js';
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await import('./swipe-back-78383f2a.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
