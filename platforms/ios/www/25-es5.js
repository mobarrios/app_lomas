...
/* harmony import */ var _overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlays-45908d8d.js */ "./node_modules/@ionic/core/dist/esm-es5/overlays-45908d8d.js");
...
/* harmony import */ var _haptic_4e92c885_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./haptic-4e92c885.js */ "./node_modules/@ionic/core/dist/esm-es5/haptic-4e92c885.js");
...
var Datetime = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.ionCancel = Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, "ionCancel", 7);
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, _overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__["p"].create(pickerOptions)];
                    case 1:
                        picker = _a.sent();
    ...
    class_1.prototype.validateColumn = function (columns, name, index, min, max, lowerBounds, upperBounds) {
        ...
        var selectedIndex = column.selectedIndex = Object(_helpers_c90aaa66_js__WEBPACK_IMPORTED_MODULE_7__["c"])(indexMin, column.selectedIndex, indexMax);
    ...
    class_1.prototype.render = function () {
        ...
        var label = Object(_helpers_c90aaa66_js__WEBPACK_IMPORTED_MODULE_7__["f"])(el);
        ...
        Object(_helpers_c90aaa66_js__WEBPACK_IMPORTED_MODULE_7__["r"])(true, el, this.name, this.value, this.disabled);
        return (Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["H"], { onClick: this.onClick, role: "combobox", "aria-disabled": disabled ? 'true' : null, "aria-expanded": "" + isExpanded, "aria-haspopup": "true", "aria-labelledby": labelId, class: (_a = {},
                _a[mode] = true,
                _a['datetime-disabled'] = disabled,
                _a['datetime-readonly'] = readonly,
                _a['datetime-placeholder'] = addPlaceholderClass,
                _a['in-item'] = Object(_theme_353a032e_js__WEBPACK_IMPORTED_MODULE_5__["h"])('ion-item', el),
                _a) }, Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "datetime-text" }, datetimeText), Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: function (btnEl) { return _this.buttonEl = btnEl; } })));
    };
...
var iosEnterAnimation = function (baseEl) {
    var baseAnimation = Object(_animation_22971d74_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
    var backdropAnimation = Object(_animation_22971d74_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
    var wrapperAnimation = Object(_animation_22971d74_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
    backdropAnimation
...
var Picker = /** @class */ (function () {
    function class_2(hostRef) {
        ...
        this.didPresent = Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, "ionPickerDidPresent", 7);
        this.willPresent = Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, "ionPickerWillPresent", 7);
        this.willDismiss = Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, "ionPickerWillDismiss", 7);
        this.didDismiss = Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, "ionPickerDidDismiss", 7);
    }
    /**
    ...
    class_2.prototype.present = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Object(_overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__["d"])(this, 'pickerEnter', iosEnterAnimation, iosEnterAnimation, undefined)];
                    case 1:
                        _a.sent();
                        if (this.duration > 0) {
    ...
    class_2.prototype.dismiss = function (data, role) {
        ...
        return Object(_overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this, data, role, 'pickerLeave', iosLeaveAnimation, iosLeaveAnimation);
    };
    /**
     * Returns a promise that resolves when the picker did dismiss.
     */
    class_2.prototype.onDidDismiss = function () {
        return Object(_overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__["f"])(this.el, 'ionPickerDidDismiss');
    };
    /**
     * Returns a promise that resolves when the picker will dismiss.
     */
    class_2.prototype.onWillDismiss = function () {
        return Object(_overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__["f"])(this.el, 'ionPickerWillDismiss');
    };
    /**
    ...
    class_2.prototype.buttonClick = function (button) {
        ...
        var shouldDismiss = Object(_overlays_45908d8d_js__WEBPACK_IMPORTED_MODULE_4__["s"])(button.handler, this.getSelected()) !== false;
        if (shouldDismiss) {
            return this.dismiss();
        }
    ...
    class_2.prototype.render = function () {
        ...
        var _this = this;
        var mode = Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this);
        return (Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["H"], { "aria-modal": "true", class: Object.assign((_a = {}, _a[mode] = true, 
            // Used internally for styling
            _a["picker-" + mode] = true, _a), Object(_theme_353a032e_js__WEBPACK_IMPORTED_MODULE_5__["g"])(this.cssClass)), style: {
                zIndex: "" + (20000 + this.overlayIndex)
            }, onIonBackdropTap: this.onBackdropTap }, Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }), Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "picker-wrapper", role: "dialog" }, Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "picker-toolbar" }, this.buttons.map(function (b) { return (Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: buttonWrapperClass(b) }, Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", { type: "button", onClick: function () { return _this.buttonClick(b); }, class: buttonClass(b) }, b.text))); })), Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "picker-columns" }, Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "picker-above-highlight" }), this.presented && this.columns.map(function (c) { return Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-picker-column", { col: c }); }), Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "picker-below-highlight" })))));
    };
...
var buttonClass = function (button) {
    return Object.assign({ 'picker-button': true, 'ion-activatable': true }, Object(_theme_353a032e_js__WEBPACK_IMPORTED_MODULE_5__["g"])(button.cssClass));
};
var PickerColumnCmp = /** @class */ (function () {
    function class_3(hostRef) {
        ...
        this.y = 0;
        this.noAnimate = true;
        this.ionPickerColChange = Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, "ionPickerColChange", 7);
    }
    ...
    class_3.prototype.update = function (y, duration, saveY) {
        ...
        if (this.lastIndex !== selectedIndex) {
            ...
            Object(_haptic_4e92c885_js__WEBPACK_IMPORTED_MODULE_6__["b"])();
    ...
    class_3.prototype.onEnd = function (detail) {
        ...
        this.velocity = Object(_helpers_c90aaa66_js__WEBPACK_IMPORTED_MODULE_7__["c"])(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
    ...
    class_3.prototype.refresh = function (forceRefresh) {
        ...
        var selectedIndex = Object(_helpers_c90aaa66_js__WEBPACK_IMPORTED_MODULE_7__["c"])(min, this.col.selectedIndex || 0, max);
    ...
    class_3.prototype.render = function () {
        ...
        return (Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["H"], { class: (_a = {},
            ...
            } }, col.prefix && (Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix)), Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: function (el) { return _this.optsEl = el; } }, col.options.map(function (o, index) { return Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])(Button, { type: "button", class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "opt-index": index }, o.text); })), col.suffix && (Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix))));
    };
